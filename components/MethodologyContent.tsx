...
/**
 * The weather-delay model write-up + validation stats. Rendered both as the
 * standalone /methodology route and as a collapsible section inside Settings,
 * where methodology now lives as supporting documentation.
 */
export function MethodologyContent({ showHeader = true }: { showHeader?: boolean }) {
