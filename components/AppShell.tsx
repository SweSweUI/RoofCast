...
export function AppShell({ children, user }: { children: ReactNode; user?: SessionUser | null }) {
  ...
  const hideCompany = pathname?.startsWith('/board') || pathname?.startsWith('/data-quality') || pathname?.startsWith('/admin');
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-20 flex flex-wrap items-center justify-between gap-3 border-b border-panel-line bg-panel/95 px-4 py-2.5 backdrop-blur">
            <div className="flex items-center gap-2">
              <span className="text-2xs font-medium uppercase tracking-wide text-ink-faint">Scenario</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <Pill tone="live" title="Near-term weeks use live Open-Meteo forecast">● Live weather</Pill>
              {user && (
